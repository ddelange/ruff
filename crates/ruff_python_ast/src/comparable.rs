...
impl<'a, 'ast> From<&'a ruff_allocator::Box<'ast, ast::Pattern<'a>>>
...
impl<'a, 'ast> From<&'a ruff_allocator::Box<'ast, ast::Arguments<'a>>>
...
impl<'a, 'ast> From<&'a ruff_allocator::Box<'ast, ast::TypeParams<'a>>>
